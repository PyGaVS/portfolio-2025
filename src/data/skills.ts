...
const skills: SkillSection[] = [
  {
    ...
    items: [
      ...
      { text: "Commandes Linux et Mac", icon: "fa-solid fa-terminal" },
      { text: "Javascript / Typescript + Adonis", icon: "fa-brands fa-js" },
      { text: "React tsx / native", icon: "fa-brands fa-react" },
      { text: "Dart + Flutter + Riverpod", icon: "fa-brands fa-google" },
      { text: "Docker", icon: "fa-brands fa-docker" },
      { text: "Kubernetes", icon: "fa-solid fa-cube" },
      { text: "C#", icon: "fa-solid fa-c" },
      { text: "Firebase", icon: "fa-solid fa-fire" },
      { text: "PrestaShop", icon: "fa-solid fa-store" },
      { text: "Java + Spring Boot + Quarkus", icon: "fa-brands fa-java" },
      { text: "Ory OIDC", icon: "fa-solid fa-key" },
    ],
  },
  {

  ...
  return (
    <Layout footer>
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 p-4 md:p-6 max-w-5/6 max-w-9xl mx-auto">
        {/* Tech carousel */}
        <div className="md:col-span-5 border-2 border-dashed border-white/50 rounded-2xl min-h-115 flex items-center justify-center">
        ...
        <div className="md:col-span-6 relative min-h-115">
          <ProjectSlideshow />
        </div>
